...
export class ProductServiceImpl implements ProductService {
  ...
  async createProduct(product: DomainProductEntity): Promise<DomainProductEntity> {
  ...
  async updateProduct(id: number, product: DomainProductEntity): Promise<DomainProductEntity> {
