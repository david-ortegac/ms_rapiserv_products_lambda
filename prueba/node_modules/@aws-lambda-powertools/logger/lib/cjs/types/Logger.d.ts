...
import type { Environment, LogAttributes, LogAttributesWithMessage, LogKeys } from './logKeys.js';
/**
 * Type definition for the log level.
 *
 * It includes the lowercase and uppercase versions of each log level.
 */
type LogLevel = (typeof LogLevelList)[keyof typeof LogLevelList] | Lowercase<(typeof LogLevelList)[keyof typeof LogLevelList]>;
/**
...
type LogBufferOption = {
    logBufferOptions?: {
         ...
         * @default `DEBUG`
         */
        bufferAtVerbosity?: Extract<(typeof LogLevelList)[keyof typeof LogLevelList], 'DEBUG' | 'INFO' | 'WARN'> | Extract<Lowercase<(typeof LogLevelList)[keyof typeof LogLevelList]>, 'debug' | 'info' | 'warn'>;
    };
};
 ...
 */
type ConstructorOptions = BaseConstructorOptions & (PersistentKeysOption | DeprecatedPersistentKeysOption) & (LogFormatterOption | LogRecordOrderOption) & LogBufferOption & CorrelationIdOption;
...
export type { ConstructorOptions, CustomJsonReplacerFn, Environment, InjectLambdaContextOptions, LogAttributes, LogFunction, LoggerInterface, LogItemExtraInput, LogItemMessage, LogLevel, };
