...
exports.getXRayTraceIdFromEnv = exports.isRequestXRaySampled = exports.getXrayTraceDataFromEnv = exports.getServiceName = exports.isDevMode = exports.getBooleanFromEnv = exports.getNumberFromEnv = exports.getStringFromEnv = void 0;
...
const isDevMode = () => {
    try {
        return getBooleanFromEnv({
            key: constants_js_1.POWERTOOLS_DEV_ENV_VAR,
            extendedParsing: true,
        });
    }
    catch {
...
const getServiceName = () => {
    return getStringFromEnv({
        key: constants_js_1.POWERTOOLS_SERVICE_NAME_ENV_VAR,
        defaultValue: '',
    });
};
...
const getXrayTraceDataFromEnv = () => {
    const xRayTraceEnv = getStringFromEnv({
        key: constants_js_1.XRAY_TRACE_ID_ENV_VAR,
        defaultValue: '',
    });
    if (xRayTraceEnv === '') {
        return undefined;
...
exports.getXrayTraceDataFromEnv = getXrayTraceDataFromEnv;
/**
...
exports.isRequestXRaySampled = isRequestXRaySampled;
/**
...
exports.getXRayTraceIdFromEnv = getXRayTraceIdFromEnv;
